...
Game::EButtonState Game::KeyboardState::GetKeyState(uint8_t InKeyCode)
{
...
bool Game::KeyboardState::IsPressKey(const std::vector<uint8_t>& InKeyboardState, uint8_t InKeyCode)
{
