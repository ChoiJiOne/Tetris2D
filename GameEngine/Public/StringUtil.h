...
public:
    ...
    static inline std::string StringFormat(const std::string& InFormat, Args ... InArgs_)
    {
    ...
    template<typename ... Args>
    static inline std::wstring StringFormat(const std::wstring& InFormat, Args ... InArgs_)
    {
