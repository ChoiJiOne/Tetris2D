...
public:
	/**
	 * @brief 크래시 덤프 경로를 설정합니다.
	 * 
	 * @param CrashDumpPath 설정할 크래시 덤프 경로입니다.
	 */
	static void SetCrashDumpPath(const std::string& CrashDumpPath) { CrashDumpPath_ = CrashDumpPath; }
...
private:
	/**
	 * @brief 에러 발생 시 생성할 크래시 덤프의 경로입니다.
	 */
	static std::string CrashDumpPath_;
