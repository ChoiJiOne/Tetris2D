...
namespace Game
{
	...
	public:
		...
		static void DrawTexture2D(SDL_Renderer* InRenderer, const std::size_t& InHashKey, const Vec2i& InCenterPosition, float InWidthScaling = 1.0f, float InHeightScaling = 1.0f);
		...
		// 
		// @throws - 렌더링에 실패할 경우, C++ 표준 예외를 던집니다.
		static void DrawText2D(SDL_Renderer* InRenderer, const std::size_t& InHashKey, const Vec2i& InPosition, const std::wstring& InText, const LinearColor& InColor);
