...
public:
	/**
	 * @brief 게임 중지 씬에서 선택할 수 있는 사항입니다.
	 */
...
public:
	/**
	 * @brief 게임 중지 씬의 생성자입니다.
	 */
	PauseScene();


	/**
	 * @brief 게임 중지 씬의 가상 소멸자입니다.
	 */
	virtual ~PauseScene();
	...
	/**
	 * @brief 게임 중지 씬의 선택 중인 상태를 얻습니다.
	 *
	 * @return 게임 중지 씬의 선택 중인 상태를 반환합니다.
	 */
